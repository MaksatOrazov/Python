# -*- coding: utf-8 -*-
"""
Created on Mon May 15 23:27:41 2023
...
phone_number = "+905413472663" #Mesaj göndermek istediğin telefon numarasını gir.

def send_random_message():
    message = get_random_message("autoMessage/messages.txt")
